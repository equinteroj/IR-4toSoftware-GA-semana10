...
\noindent
\textbf{Aquí va la imagen del Diagrama de Actividades.}
...
\noindent
\textbf{Aquí va la imagen del Diagrama de Máquina de Estados.}
...
\noindent
\textbf{Aquí va la imagen del Diagrama de Secuencia.}
...
Los diagramas fuente en formato editable (draw.io / StarUML) y sus exportaciones en alta resolución
(PNG/SVG) se encuentran versionados en el repositorio del proyecto, en la carpeta
\texttt{evidencias/diagramas/}, referenciado desde el repositorio general del equipo AHMRV:
\url{https://github.com/AlanNVR/Villafuerte_Grupo_AHMRV/tree/main/AHMRV}. A continuación se listan los
marcadores de las figuras que deben insertarse en dicha carpeta y enlazarse en este documento:

\begin{itemize}
  \item \textbf{Aquí va la imagen del Diagrama ER.}
  \item \textbf{Aquí va la imagen del Diagrama de Clases UML.}
  \item \textbf{Aquí va la imagen del DFD Nivel 0.}
  \item \textbf{Aquí va la imagen del DFD Nivel 1.}
  \item \textbf{Aquí va la imagen del DFD Esencial.}
  \item \textbf{Aquí va la imagen del Diagrama de Actividades.}
  \item \textbf{Aquí va la imagen del Diagrama de Máquina de Estados.}
  \item \textbf{Aquí va la imagen del Diagrama de Secuencia.}
\end{itemize}
...
contenido, su coherencia con el PFC y la verificación de los DOI reales quedó a cargo del equipo
AHMRV.
...
\begin{enumerate}[label=\lbrack{}\arabic*\rbrack{}]
  ...
  Addison-Wesley, 2007.
  \item D. Harel, ``Statecharts,'' \textit{Science of Computer Programming}, 1987,
